                        ...
                        <table id="programsTable" class="table-auto w-full border-collapse">
                            <thead class="table-header">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 border border-slate-400">
                                        <i class="fas fa-calendar-alt mr-2"></i>Publish Date
                                    </th>
                                    <th class="px-4 py-2 border border-slate-400">
                            ...
                            <tbody class="text-center">
                                @foreach ($programs as $program)
                                    <tr class="bg-white dark:bg-gray-700">
                                        <td class="border px-4 py-2 font-bold">{{ $program->programName }}</td>
                                        <td class="border px-4 py-2">{{ $program->created_at->translatedFormat('jS F, Y h:i A') }}</td>
                                        <td class="border px-4 py-2 text-center">
                                            <a href="{{ route('program.view', $program->uid) }}" class="action-btn">
