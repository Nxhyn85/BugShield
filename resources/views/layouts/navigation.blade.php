            ...
            <div class="flex">
                ...
                <!-- Navigation Links -->
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <x-nav-link :href="route('admin.program.add')" :active="request()->routeIs('admin.program.add')">
                            {{ __('Add Program') }}
                        </x-nav-link>
                        ...
                        <x-nav-link :href="route('admin.programs')" :active="request()->routeIs('admin.programs')">
                            {{ __('Programs') }}
                        </x-nav-link>
